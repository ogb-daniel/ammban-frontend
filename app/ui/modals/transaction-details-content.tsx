...
export const generateTransactionDetailsHTML = (
        ...
        <div class="flex items-center gap-3">
          ${
            transactionDetails.logoText
              ? `
            <div class="w-10 h-10 bg-primary rounded flex items-center justify-center text-white font-bold text-xs">
              ${transactionDetails.logoText}
            </div>
          `
              : ""
      ...
      <div class="space-y-4">
        ...
        ${
          transactionDetails.transactionId
            ? `
          <div class="flex justify-between items-center py-2 border-t border-gray-100 mt-4 pt-4">
